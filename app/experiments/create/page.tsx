        ...
        <form onSubmit={handleSubmit} className="p-8 sm:p-10 space-y-8">
          ...
          <div className="pt-6 border-t border-green-300 flex items-center justify-end gap-6 bg-green-50 -mx-8 sm:-mx-10 -mb-8 sm:-mb-10 px-8 sm:px-10 py-6 border-t-4 border-[#166534]">
            ...
            <button
              ...
              className={`relative flex items-center justify-center gap-2 px-8 py-3 font-bold uppercase tracking-wide text-white border-2 transition-colors ${isSubmitting || !name.trim()

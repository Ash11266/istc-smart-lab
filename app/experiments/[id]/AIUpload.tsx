  ...
  return (
    <div className="bg-white border p-6 mt-6 rounded-lg shadow-sm">
      <div className="flex justify-between items-center mb-4">
        ...
        {reportText && (
          <button
            ...
            className="px-4 py-2 rounded shadow font-bold transition-transform hover:scale-105 hover:shadow-lg"
          >
      ...
      <button
        ...
        className="px-4 py-2 mt-2 rounded text-white font-bold transition-transform shadow hover:scale-105 hover:shadow-lg"
      >
        {loading ? "Generating Comprehensive Report..." : "Generate AI Report"}
      </button>

      {reportText && (
        <div id="ai-report-content" className="mt-6 p-6 bg-blue-50/50 rounded border border-blue-100 prose prose-blue max-w-none">
